...
- (void)setBottomSpace:(CGFloat)bottomSpace
{
    ...
    self.height = superView.height - self.top + bottomSpace;
...
- (void)setRightSapce:(CGFloat)rightSapce
{
    UIView *superView = self.superview;
    self.width = superView.width - self.left + rightSapce;
}
...
- (void)setEdge:(UIEdgeInsets)edge
{
    self.top = edge.top;
    self.left = edge.left;
    self.bottomSpace = edge.bottom;
    self.rightSapce = edge.right;
}

- (UIEdgeInsets)edge
{
    return UIEdgeInsetsMake(self.top, self.left, self.bottomSpace, self.rightSapce);
}
